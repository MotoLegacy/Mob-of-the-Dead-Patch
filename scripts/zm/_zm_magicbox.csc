...
#precache( "client_fx", "custom/jerri/al_box/al_box_open" );
#precache( "client_fx", "custom/jerri/al_box/al_box_close" );
...
function __init__()
{
	level._effect["chest_light"] = "custom/jerri/al_box/al_box_open"; 
	level._effect["chest_light_closed"] = "custom/jerri/al_box/al_box_close";  

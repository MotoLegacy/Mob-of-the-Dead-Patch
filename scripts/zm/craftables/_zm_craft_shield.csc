...
function __init__()
{
	...
	RegisterClientField( "world", CLIENTFIELD_CRAFTABLE_PIECE_RIOTSHIELD_DOLLY,	VERSION_SHIP, 1, "int", &SetPlayerUI, !CF_HOST_ONLY, CF_CALLBACK_ZERO_ON_NEW_ENT );
	RegisterClientField( "world", CLIENTFIELD_CRAFTABLE_PIECE_RIOTSHIELD_DOOR, VERSION_SHIP, 1, "int", &SetPlayerUI, !CF_HOST_ONLY, CF_CALLBACK_ZERO_ON_NEW_ENT );
	RegisterClientField( "world", CLIENTFIELD_CRAFTABLE_PIECE_RIOTSHIELD_CLAMP,	VERSION_SHIP, 1, "int", &SetPlayerUI, !CF_HOST_ONLY, CF_CALLBACK_ZERO_ON_NEW_ENT );
